...
import { HTTPStatus } from 'src/app/Services/log-interceptor.service';
// import { HTTPStatus } from '../../Services/log-interceptor.service';
...
export class DashBoardComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    isbussy: boolean;
    public allowBlock: boolean;

    constructor(public renderer2: Renderer2, public zone: NgZone, private router: Router, private userService: UserService, private httpStatus: HTTPStatus) {
        this.allowBlock = true;
    }
    public permitirBloqueo(value) {
