    ...
    template: `
        <div class="profile" [ngClass]="{'profile-expanded':active}">
            <a href="#" (click)="onClick($event)">
                <img class="profile-image" src="assets/layout/images/entrega.png" />
                <span class="profile-name">Garbage collection Planning</span>
        ...
        <ul class="ultima-menu profile-menu" [@menu]="active ? 'visible' : 'hidden'" >
            ...
            <li role="menuitem">
                <a href="#"  class="ripplelink" [attr.tabindex]="!active ? '-1' : null" (click)='app.logout()'>
